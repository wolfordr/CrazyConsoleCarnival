...
namespace TextCarnivalV2.Source.CarnivalGames.AllCarnivalGames
{
    class Hunter : CarnivalGame
    {
        ...
        public override void play()
        {
            ...
            showTitle("WELCOME TO THE HUNTING GAME!");

            writeLine("You will be pitted against 5 hunters trying to kill you.  This is a basic tutorial on how to use this text basted engine and make games");
